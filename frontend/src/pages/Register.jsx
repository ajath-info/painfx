          ...
          <div className="w-full md:w-1/2 p-8 shadow-lg">
            ...
            <form onSubmit={handleRegister} className="space-y-4">
              ...
              <div className="flex space-x-4">
                ...
                <button type="button" className="cursor-pointer flex items-center justify-center space-x-2 w-1/2 border border-red-500 text-red-500 py-2 rounded hover:bg-red-500 hover:text-white transition" disabled={loading}>

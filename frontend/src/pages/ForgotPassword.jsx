...
const ForgotPassword = () => {
  ...
  return (
    ...
    <div className="min-h-screen flex items-center justify-center px-4">
      <div className="flex flex-col md:flex-row w-full max-w-4xl bg-white rounded-lg overflow-hidden">
        {/* Left side - Logo and Background */}
        <div className="md:w-1/2 flex mb-20 items-center justify-center p-10">
          <img src={Banner} alt="Logo" className="max-w-full h-auto" />
        </div>
        ...
        <div className="md:w-1/2 p-8 md:p-12">
          ...
          <form className="space-y-4">
            ...
            <button
              type="submit"
              onClick={() => navigate('/check-validation')}

  ...
  return (
    <AdminLayout>
      <div className="flex-1 p-6 bg-gray-100 min-h-screen">
        <div className="mb-6">
          <h2 className="text-3xl font-bold text-gray-800 mb-2">Partner Management</h2>
          <p className="text-gray-600 text-sm">Dashboard / Partners</p>
        </div>
                ...
                {partners.map((partner, idx) => (
                  <tr key={partner.id} className="hover:bg-gray-50 transition-colors">
                    ...
                    <td className="px-6 py-4 text-sm flex space-x-2">
                      <button onClick={() => handleEdit(partner)} className="px-3 py-1 bg-yellow-500 text-white rounded cursor-pointer">
                        <Edit className="w-4 h-4" />
                      </button>
                      <button onClick={() => handleDelete(partner.id)} className="px-3 py-1 bg-red-500 text-white rounded cursor-pointer">

  ...
  return (
    <AdminLayout>
      <div className="flex-1 p-6 bg-gray-100 min-h-screen">
        <div className="mb-6">
          <h2 className="text-3xl font-bold text-gray-800 mb-2">GDPR Management</h2>
          <p className="text-gray-600 text-sm">Dashboard / GDPR</p>
        </div>
          ...
          <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
            <div className="bg-white rounded-xl shadow-2xl p-6 w-full max-w-md">
              <h3 className="text-xl font-semibold text-gray-800 mb-6">
                {current ? 'Edit GDPR' : 'Add New GDPR'}
              </h3>
              <form onSubmit={handleSubmit}>
                ...
                <div className="mb-4">
                  <label className="block text-sm font-medium mb-1">GDPR Logo</label>

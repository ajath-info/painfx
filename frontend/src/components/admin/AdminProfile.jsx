...
const AdminProfile = () => {
  ...
  const validateProfile = () => {
    ...
    if (formData.mobile && !/^\d{3}-\d{3}-\d{4}$/.test(formData.mobile))
      newErrors.mobile = 'Please enter a valid mobile number (e.g., 123-456-7890).';
  ...
  const validatePassword = () => {
    ...
    if (passwordData.newPassword.length < 8) newErrors.newPassword = 'New password must be at least 8 characters long.';
    if (!/[A-Z]/.test(passwordData.newPassword)) newErrors.newPassword = 'New password must contain at least one uppercase letter.';
    if (!/[0-9]/.test(passwordData.newPassword)) newErrors.newPassword = 'New password must contain at least one number.';
          ...
          <div className="flex flex-col md:flex-row md:items-center md:justify-between">
            <div className="flex items-center gap-6">
              ...
              <div>
                ...
                <p className="text-cyan-600 font-medium">{profile.designation}</p>
                ...
                <div className="flex items-center mt-1 text-gray-500">
                  ...
                  <span className="text-sm">{profile.address.split(',')[1]?.trim() || 'United States'}</span>
                </div>
                <div className="flex items-center mt-1 text-gray-500">

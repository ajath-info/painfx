...
const Footer = () => {
  ...
  <div>
    ...
    <p className="text-sm leading-relaxed mb-6 max-w-lg mx-auto lg:mx-0 text-center lg:text-left">
      ...
      <br />8 Charm Street, PalmView, QLD 4553
    </p>
...
<div className="mt-30 sm:mt-0">
  ...
  <div>
    <h4 className="font-semibold">Terms and Conditions | Privacy Policy</h4>
  </div>
</div>

        <div className="mt-6 text-center pt-4 border-t border-white">
            <div>
            <h4 className="font-semibold mb-2">Powered and Managed by Digitallifestream</h4>
          </div>
          <p>

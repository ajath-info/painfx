  ...
  const handleSubmit = (e) => {
    ...
    const bookingDetails = {
      ...
      doctor: {
        ...
        total: doctor?.consultationFee || 100,
      },
      address: formData.visitType === "home"
        ? {
        ...
        <div className="grid md:grid-cols-3 gap-6">
          ...
          >
            ...
            <div className="space-y-2">
              ...
              <select
                ...
                onChange={handleChange}
                className="w-full border border-gray-300 rounded-md px-4 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-[#09DCA4]"
              >
          ...
          <div className="bg-white shadow rounded p-8 border border-gray-200 h-fit">
            ...
            <div className="mt-6 space-y-2 text-sm text-gray-700">
              ...
              <hr />
              <p className="flex justify-between font-bold text-[#0078FD]"><span className="font-bold text-lg">Total</span><span className="text-lg">${doctor?.consultationFee || 100}</span></p>
            </div>
          </div>
        </div>
      </div>
